...
public class LookupService implements Serializable {
    ...
    private static final String[] countryName = { "No Disponible", "Región Asia/Pacifico",
            "Europa", "Andorra", "Emiratos Árabes Unidos", "Afganistán",
            "Antigua y Barbuda", "Anguila", "Albania", "Armenia", "Curazao",
            "Angola", "Antartica", "Argentina", "Samoa Americana", "Austria",
            "Australia", "Aruba", "Azerbaijan", "Bosnia y Herzegovina",
            "Barbados", "Bangladesh", "Belgica", "Burkina Faso", "Bulgaria",
            "Bareín", "Burundi", "Benín", "Bermuda", "Brunéi",
            "Bolivia", "Brasil", "Bahamas", "Bután", "Isla Bouvet",
            "Botswana", "Bielorrusia", "Belice", "Canadá",
            "Cocos (Keeling) Islands", "República Democrática del Congo",
            "República Centroafricana", "Congo", "Suiza",
            "Costa de Marfil", "Islas Cook", "Chile", "Camerún", "China",
            "Colombia", "Costa Rica", "Cuba", "Cabo Verde", "Isla de Navidad",
            "Chipre", "República Checa", "Alemania", "Djibouti", "Dinamarca",
            "Dominica", "República Dominicana", "Argelia", "Ecuador", "Estonia",
            "Egipto", "Sahara Occidental", "Eritrea", "España", "Etiopia",
            "Finlandia", "Fiji", "Malvinas",
            "Micronesia", "Islas Faroe", "Francia",
            "Sint Maarten (Dutch part)", "Gabon", "Reino Unido", "Granada",
            "Georgia", "French Guiana", "Ghana", "Gibraltar", "Groenlandia",
            "Gambia", "Guinea", "Guadalupe", "Guinea Ecuatorial", "Grecia",
            "South Georgia and the South Sandwich Islands", "Guatemala",
            "Guam", "Guinea-Bissau", "Guyana", "Hong Kong",
            "Heard Island and McDonald Islands", "Honduras", "Croacia",
            "Haití", "Hungria", "Indonesia", "Irlanda", "Israel", "India",
            "British Indian Ocean Territory", "Iraq",
            "Iran", "Islandia", "Italia", "Jamaica",
            "Jordania", "Japón", "Kenya", "Kyrgyzstan", "Cambodia", "Kiribati",
            "Comoros", "Saint Kitts and Nevis",
            "República Democrática de Corea", "República de Corea",
            "Kuwait", "Islas Caiman", "Kazakhstan",
            "Lao People's Democratic Republic", "Líbano", "Saint Lucia",
            "Liechtenstein", "Sri Lanka", "Liberia", "Lesotho", "Lituania",
            "Luxemburgo", "Lituania", "Libya", "Marruecos", "Mónaco",
            "Moldavia", "Madagascar", "Islas Marshall",
            ...
            "Norfolk Island", "Nigeria", "Nicaragua", "Países Bajos", "Noruega",
            "Nepal", "Nauru", "Niue", "Nueva Zelanda", "Oman", "Panamá", "Perú",
            "Polinesia Francesa", "Papua New Guinea", "Filipinas", "Pakistan",
            "Polonia", "Saint Pierre and Miquelon", "Pitcairn Islands",
            "Puerto Rico", "Palestina", "Portugal", "Palau",
            "Paraguay", "Qatar", "Reunion", "Rumania", "Rusia",
            "Rwanda", "Arabia Saudi", "Solomon Islands", "Seychelles", "Sudan",
            "Suecia", "Singapur", "Saint Helena", "Eslovenia",
            "Svalbard and Jan Mayen", "Eslovaquia", "Sierra Leona", "San Marino",
            ...
            "Tunez", "Tonga", "Timor-Leste", "Turquia", "Trinidad y Tobago",
            "Tuvalu", "Taiwan", "Tanzania, United Republic of", "Ukrania",
            "Uganda", "United States Minor Outlying Islands", "Estados Unidos",
            ...
            "Proxy Anónimo", "Proveedor Satelital", "Otro", "Aland Islands",
