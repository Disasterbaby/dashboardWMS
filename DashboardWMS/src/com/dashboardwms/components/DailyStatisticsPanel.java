...
public class DailyStatisticsPanel extends Panel {
	...
	private void fillContentWrapperGraficoPeriodo(String periodo) throws InvalidResultSetAccessException, ParseException {
		...
		listaAplicaciones = clienteService.getUsuariosConectadosPorHora(emisora, fechaInicio.getTime(), fechaFin);
	...
	private XYDataset datasetPeriodo(LinkedHashMap<Date, Integer> listaAplicaciones) {
	...
	public void fillData() throws InvalidResultSetAccessException, ParseException {
